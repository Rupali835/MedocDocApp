...
@objc open class ZAlertView: UIViewController {
    ...
    open static var titleColor: UIColor?  = UIColor(red:0.40, green:0.23, blue:0.72, alpha:1.0)
    
    open static var buttonTitleColor: UIColor?         = UIColor.white
    
    open static var messageColor: UIColor?             =
    ...
    func setupViews() {
        ...
        self.lbTitle.font          = ZAlertView.alertTitleFont ?? UIFont.boldSystemFont(ofSize: 22)
        ...
        self.lbMessage.font          = ZAlertView.messageFont ?? UIFont.systemFont(ofSize: 20)
    ...
    open func addTextField(_ identifier: String, placeHolder: String) {
        addTextField(identifier,
            ...
            font: ZAlertView.messageFont ?? UIFont.systemFont(ofSize: 20),
